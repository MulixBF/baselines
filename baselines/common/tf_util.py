...
def make_session(num_cpu=None, make_default=False, debug=False):
    ...
    tf_config.gpu_options.allocator_type = u'BFC'
    if make_default:
...
class _Function(object):
    ...
    def __call__(self, *args):
        assert len(args) <= len(self.inputs), u"Too many arguments provided"
        feed_dict = {}
        # Update the args
