...
def model(img_in, num_actions, scope, reuse=False):
    u"""As described in https://storage.googleapis.com/deepmind-data/assets/papers/DeepMindNature14236Paper.pdf"""
...
def dueling_model(img_in, num_actions, scope, reuse=False):
    u"""As described in https://arxiv.org/abs/1511.06581"""
    with tf.variable_scope(scope, reuse=reuse):
        out = img_in
        with tf.variable_scope(u"convnet"):
            # original architecture
